...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        String[] publicEndpoints = {
            ...
            "/api/producto/categoria/**", "/api/auth/**", "/home", "/carrito",
            "/api/pedidos/addPedido", "/", "/api/clientes/addCliente", "/register",
        ...
        http.csrf(csrf -> csrf.disable())
            .authorizeHttpRequests(auth -> auth
                ...
                // Aquí están los endpoints para pedidos:
                .requestMatchers("/api/pedidos/delete/**", "/api/pedidos/editar/**", "/api/pedidos/estado/**")
                    .hasAuthority("ADMIN")
