...
public class ClienteRepoTest {
	...
	public void pruebaCuandoSeGuardaEntoncesElementoEsEncontrado() {
		final Cliente cliente1 = new Cliente("NombreDelCliente", "username", "password", "correo1", new HashSet<>());
	...
	public void pruebaCuandoSeGuardaEntoncesFallaSiusernameYaExiste() {
		...
		final Cliente cliente2 = new Cliente("NombreCliente2", "username1", "contrasena", "correo2", new HashSet<>());
	...
	public void pruebaCuandoSeGuardaConAutoridadesEntoncesSeRecuperanCorrectamente() {
		HashSet<UserAuthority> autoridades = new HashSet<>();
		autoridades.add(UserAuthority.ADMIN);
		autoridades.add(UserAuthority.USER);
		final Cliente cliente1 = new Cliente("NombreCliente1", "username1", "contrasena", "correo1", autoridades);
		clienteRepositorio.save(cliente1);
		final Cliente cliente2 = clienteRepositorio.getReferenceById(cliente1.getId());
